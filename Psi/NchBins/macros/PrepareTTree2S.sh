...
#Define JobID
JobIDName=2011Psi2S_NchInt #2012datarun #change job id name here, automatically updates below
...
if [ ${nState} -eq 5 ]
then
inputTree1=/data/users/ferraioc/TTree_Onia2MuMu_v30_PromptRecoAB_10May2012_Psi.root #2011
...
if [ ${MC} = 'true' ]
then
inputTree1=/scratch/ikratsch/Polarization/Jpsi/InputFiles/TTree_Psi2S_Gun_Pt6p5_50p5_19Dec2012.root #2011 file
fi
fi
