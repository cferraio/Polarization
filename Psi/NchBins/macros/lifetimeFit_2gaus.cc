...
//		ws->var("bkgTauDSD")->setVal(.01);
		...
		if((ptBin==5 ) && rapBin==1){
			ws->var("fBkgSSDR_SBL")->setVal(.715); //0.4
			ws->var("fBkgSSDR_SBR")->setVal(.715);
		...
		if(ptBin==2  && rapBin==2){
			ws->var("fBkgSSDR_SBL")->setVal(.685); //0.4
			ws->var("fBkgSSDR_SBR")->setVal(.685);
			ws->var("fBkgDSD_SBL")->setMax(.2);
			ws->var("fBkgDSD_SBR")->setMax(.2);
		
		}
		
		if(ptBin>7 || (ptBin==6 &&rapBin==2)){
			//// old
...
//			ws->var("fBkgSSDR_SBR")->setConstant(kTRUE);
		...
		if(ptBin == 1 && cpmBin == 8){
			ws->var("fBkgSSDR_SBL")->setVal(.5);
			ws->var("fBkgSSDR_SBR")->setVal(.5);
//			ws->var("fBkgSSDR_SBL")->setConstant(kTRUE);
//			ws->var("fBkgSSDR_SBR")->setConstant(kTRUE);
			ws->var("fBkgDSD_SBL")->setMax(.215);
			ws->var("fBkgDSD_SBR")->setMax(.215);
		...
		if(ptBin == 1 && cpmBin == 2){
			ws->var("fBkgSSDR_SBL")->setVal(.65);
			ws->var("fBkgSSDR_SBR")->setVal(.65);			ws->var("fBkgSSDR_SBL")->setConstant(kTRUE);
			ws->var("fBkgSSDR_SBR")->setConstant(kTRUE);
			ws->var("fBkgDSD_SBL")->setMax(.215);
			ws->var("fBkgDSD_SBR")->setMax(.215);
		}
...
//			ws->var("fBkgSSDR_SBR")->setConstant(kTRUE);
		...
		if(ptBin == 2 && cpmBin == 8){
			ws->var("fBkgSSDR_SBL")->setVal(.8);
			ws->var("fBkgSSDR_SBR")->setVal(.8);
			ws->var("fBkgSSDR_SBL")->setConstant(kTRUE);
			ws->var("fBkgSSDR_SBR")->setConstant(kTRUE);
//			ws->var("bkgTauFD")->setVal(.2);
			ws->var("fBkgDSD_SBL")->setMax(.25);
			ws->var("fBkgDSD_SBR")->setMax(.25);
		}
	...
	if(nState==4){
	  ...
	  ws->var("fBkgDSD_SBL")->setVal(.125);
	  ws->var("fBkgDSD_SBR")->setVal(.125);
	  ws->var("fBkgSSDR_SBL")->setVal(.775);
	  ws->var("fBkgSSDR_SBR")->setVal(.775);
	  ws->var("fBkgSSDR_SBL")->setConstant(kTRUE);
	  ws->var("fBkgSSDR_SBR")->setConstant(kTRUE);
...
/*	  if(ptBin == 1 && cpmBin == 2){
	...
	*/  
	  ...
	  ws->var("bkgTauSSD_SBL")->setMax(1.);
	  ws->var("bkgTauSSD_SBL")->setVal(.44);
	  ws->var("bkgTauSSD_SBR")->setVal(.44);
	  ws->var("bkgTauSSD_SBR")->setMax(1.);
	  ws->var("bkgTauFD")->setMax(0.3);
	  ws->var("bkgTauFD")->setVal(0.055);
	  ws->var("bkgTauFD")->setConstant(kTRUE);
	  ws->var("nonPromptTau")->setMax(1.);
	  ws->var("promptMean")->setVal(0.);
	  ws->var("ctResolution")->setVal(.9);
	  ws->var("promptMean")->setConstant(kTRUE);
