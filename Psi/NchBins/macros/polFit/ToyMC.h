...
int binCosth[nRapBins][nPtBins][ncpmBins]={{{35, 27, 32, 32, 16},{30, 24, 32, 32, 16}}};
int binPhi  [nRapBins][nPtBins][ncpmBins]={{{16, 16, 16, 16, 16},{16, 16, 16, 16, 16}}};

//// ToyBackground
double fracBackground[nRapBins][nPtBins][ncpmBins]={{{0.01,0.01,0.01,0.01,0.01},{0.01,0.01,0.01,0.01,0.01}}};
//// from real data
...
//double ptCentre[nRapBins][nPtBins][ncpmBins]={{{11.8943,11.8943},{15.7294,15.7294},{19.7371,19.7371},{25.1272,25.1272},{36.1102,36.1102}},{{11.8943,11.8943},{15.7294,15.7294},{19.7371,19.7371},{25.1272,25.1272},{36.1102,36.1102}}};
double cpmCentre[nRapBins][nPtBins][ncpmBins]={{{8, 20, 30, 43, 60},{8, 20, 30, 43, 60}}};
int numEvents[nRapBins][nPtBins][ncpmBins]={{{48068, 18033, 6802, 3944, 1288},{19481, 7892, 2808, 1777, 609}}};//Psi(2S)
