...
double fracBackground[nRapBins][nPtBins][ncpmBins]={{{0.217064, 0.229161, 0.250401, 0.277989, 0.316893},{0.353699, 0.300429, 0.311203, 0.311682, 0.324242}}};
...
//PHX int binPhi[nRapBins][nPtBins][ncpmBins]={{{16, 16, 16, 16, 16},{16, 16, 16, 16, 16}}};

//PHX int binCosth[nRapBins][nPtBins][ncpmBins]={{{32, 64, 64, 32, 32},{16, 32, 32, 16, 16}}};
