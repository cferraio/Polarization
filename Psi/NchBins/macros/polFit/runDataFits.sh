...
nRhoFactor=1 ## from ilse 17 sep 2015
...
resultfilename=resultsMerged_Psi$[nState-3]S_rap${rap_}_pT${pT_}_cpm${cpm}.root
...
cp ${storagedir}/${JobID}/polGenRecFitPlot ${storagedir}/${JobID}/polGenRecFitPlot_Psi$[nState-3]S_rap${rap_}_pt${pT_}_cpm${cpm_}_Gen${nGen_}
...
rm polGenRecFitPlot_Psi$[nState-3]S_rap${rap_}_pt${pT_}_cpm${cpm_}_Gen${nGen_}
