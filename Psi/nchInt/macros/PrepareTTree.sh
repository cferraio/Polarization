...
if [ ${nState} -eq 4 ]
then
#inputTree1=/data/users/ferraioc/Polarization/2016datafile.root #2016 file
#inputTree1=/data/users/ferraioc/Polarization/2015datafile.root #2015 file
...
if [ ${officialMC} = 'true' ]
then
inputTree1=/data/users/ferraioc/Polarization/2016datafile.root #2016 data file
#inputTree1=/data/users/ferraioc/Polarization/2012ppOniaData/onia2MuMu_tree_validation.root
...
if [ ${PbPb2015} = 'true' ]
then
cp PolDataPbPb2015.h ${WorkDir}/PolData.h
cp PolDataPbPb2015.C ${WorkDir}/PolData.C
fi
