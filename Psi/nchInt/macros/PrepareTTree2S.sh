...
DataID=Psi$[nState-3]S_ctauScen0_FracLSB-1_2011DataPsi2S
polDataPath=${basedir}/Psi/Data/${DataID}

#Define JobID
JobID=ctauScen${ctauScen}_FracLSB${FracLSB}_2011DataPsi2S
...
if [ ${nState} -eq 4 ] 
then
inputTree1=/data/users/ferraioc/TTree_Onia2MuMu_v30_PromptRecoAB_10May2012_Jpsi.root #2011 data
#inputTree1=/data/users/ferraioc/Polarization/2012ppOniaData/r2012A_DoubMuPk_jpsi_v6.root
#inputTree2=/data/users/ferraioc/Polarization/2012ppOniaData/r2012B_MuPk_jpsi_v6.root
#inputTree3=/data/users/ferraioc/Polarization/2012ppOniaData/r2012C_MuPk_jpsi_v6.root
#inputTree4=/data/users/ferraioc/Polarization/2012ppOniaData/r2012D_MuPk_jpsi_v6.root
if [ ${MC} = 'true' ]
then
...
if [ ${nState} -eq 5 ]
then
#inputTree1=/data/users/ferraioc/Polarization/2012ppOniaData/r2012A_DoubMu_psi2s_v15.root
#inputTree2=/data/users/ferraioc/Polarization/2012ppOniaData/r2012B_MuPk_psi2s_v15.root
#inputTree3=/data/users/ferraioc/Polarization/2012ppOniaData/r2012C_MuPk_psi2s_v15.root
#inputTree4=/data/users/ferraioc/Polarization/2012ppOniaData/r2012D_MuPk_psi2s_v15.root
inputTree1=/data/users/ferraioc/TTree_Onia2MuMu_v30_PromptRecoAB_10May2012_Psi.root #2011 dataset
if [ ${MC} = 'true' ]
then
