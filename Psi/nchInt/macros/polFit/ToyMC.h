...
int binCosth[nRapBins][nPtBins]={{64, 48, 48, 48, 32},{64, 48, 48, 48, 32}};
int binPhi[nRapBins][nPtBins]={{16, 16, 16, 16, 16},{16, 16, 16, 16, 16}};

double fracBackground[nRapBins][nPtBins]={{0.001,0.001,0.001,0.001,0.001},{0.001,0.001,0.001,0.001,0.001}}; //for chi_c1
double fracBackgrounderr[nRapBins][nPtBins]={{0.0001,0.0001,0.0001,0.0001,0.0001},{0.0001,0.0001,0.0001,0.0001,0.0001}};

double ptCentre[nRapBins][nPtBins]={{12.8782,17.2027,22.2145,27.1524,36.1774},{12.8782,17.2027,22.2145,27.1524,36.1774}}; //from real data
int numEvents[nRapBins][nPtBins]={{8288,7770,3679,1654,1534},{8288,7770,3679,1654,1534}}; // chi_c1
*/
...
double fracBackgrounderr[nRapBins][nPtBins]={{0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01},{0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01}};
//// from real data
