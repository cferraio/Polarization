...
JobID=cutNPriVtx #MCclosure_Ups3S_Sept8 #July27_CowboyFix #MCclosure_Ups3S_July25 #MCclosure_Ups1S_July25 #May20Centrals #HighCtau3_BGratioTest #MCclosure #FinalData_CtauSig2 #_NoCtauCut #

for FidCuts in 11;do 				#defines the set of cuts to be used, see macros/polFit/effsAndCuts.h

for FracLSB in 44;do				#in percent; the left mass sideband will be weighted accordingly with respect to the right mass sideband
