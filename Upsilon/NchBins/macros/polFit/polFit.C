...
//	if(nRhoFactor==331) sprintf(EffFile,"%s/map.root",effDir);
  ...
  cout<<"rhofactor is: "<<EffFile<<endl;
...
//    cout<<"costh_PX = "<<costh_PX<<", phi_PX = "<<phi_PX<<endl;
    ...
    if(nRhoFactor>320 && nRhoFactor<332) {costh_RhoFactor=costh_PX; phi_RhoFactor=phi_PX;}
...
*/
  ...
  //////////////////////////////////////////////////////////////////////////////////
  // fill histograms with the kinematics of all signal events (signal)
