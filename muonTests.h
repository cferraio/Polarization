...
// used to generate this class and read the Tree.
   if (tree == 0) {
     // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data/users/ferraioc/Polarization/2012ppOniaData/r2012A_DoubMu_jpsi_v8.root");
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data/users/ferraioc/TTree_Onia2MuMu_v30_PromptRecoAB_10May2012_Jpsi.root");
      if (!f || !f->IsOpen()) {
      //   f = new TFile("/data/users/ferraioc/Polarization/2012ppOniaData/r2012A_DoubMu_jpsi_v8.root");
      	f = new TFile("/data/users/ferraioc/TTree_Onia2MuMu_v30_PromptRecoAB_10May2012_Jpsi.root");
      }
